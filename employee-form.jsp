...
<div align="center">
	...
	<table border="1" cellpadding="5">
		...
		<tr>
			...
			<td><input type="text" name="dbranch" value="<c:out value='${existingDepartment.deptBranch}' />" /> 
			</td>
		</tr>
		<tr>
			<th> Department Location: </th>
			<td><input type="text" name="dlocation" value="<c:out value='${existingDepartment.deptLocation}' />" /> 
			</td>
		</tr>
		<tr>
